...
public enum GatewayError {
    ...
    PLAYLIST_SONG_ERROR_CATEGORY_DOES_NOT_EXIST("004.004", HttpStatus.INTERNAL_SERVER_ERROR),
    PLAYLIST_SONG_ERROR_PLAYLIST_DOES_NOT_EXIST("004.005", HttpStatus.INTERNAL_SERVER_ERROR);
