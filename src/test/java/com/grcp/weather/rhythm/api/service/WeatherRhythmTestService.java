...
public class WeatherRhythmTestService {
    ...
    @ParameterizedTest
    @ValueSource(doubles = {59.0, 65.0, 70.0, 75.0, 80.0, 83.0, 86.0})
    ...
    @ParameterizedTest
    @ValueSource(doubles = {50.0, 55.0, 57.0})
    ...
    @ParameterizedTest
    @ValueSource(doubles = {10.0, 20.0, 32.0, 42.0, 49.0})
